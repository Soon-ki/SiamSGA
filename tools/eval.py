...
from toolkit.datasets import OTBDataset, UAVDataset, LaSOTDataset, NFSDataset, GOT10kDataset
...
parser.add_argument('--tracker_path', '-p', type=str, default='./results', help='tracker result path')
# GOT  LaSOT  NFS30 NFS240 OTB100 UAV123
parser.add_argument('--dataset', '-d', type=str, default='LaSOT', help='dataset name')
parser.add_argument('--num', '-n', default=14, type=int, help='number of thread to eval')
...
def main():
    ...
    if 'OTB' in args.dataset:
        ...
        benchmark.show_result(success_ret, precision_ret, norm_precision_ret, show_video_level=args.show_video_level)
    ...
    draw_success_precision(success_ret, trackers, dataset.videos, attr='ALL', precision_ret=precision_ret, norm_precision_ret=None, bold_name=None, axis=[0, 1])
